...
export default defineConfig({
  shortcuts: [
    ['btn', 'px-4 py-1 rounded inline-block bg-yellow-600 text-white cursor-pointer hover:bg-yellow-700 disabled:cursor-default disabled:bg-gray-600 disabled:opacity-50'],
